<?php
        ...
        if ($opt == 'post'){
            ...
            if (checksubmit('submit')) {
                ...
                message('图片添加成功!', $this->createWeburl('Shopset', array('id' => $id, 'opt' =>'post','op' => 'banner','cateid'=>$_GPC['cateid'],'chid'=>$_GPC['chid'],'id' => $item['id'])), 'success');
        ...
        if ($opt == 'delete') {
            ...
            message('删除成功!', $this->createWeburl('Shopset', array('id' => $id, 'opt' =>'banner','op' => 'banner','cateid'=>$_GPC['cateid'],'chid'=>$_GPC['chid'])), 'success');

        }
return include self::template('web/Shopset/banner');
