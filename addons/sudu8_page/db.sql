...
-- ----------------------------
-- Table structure for `ims_sudu8_page_banner`
-- ----------------------------
...
-- ----------------------------
-- Records of ims_sudu8_page_banner
-- ----------------------------
...
CREATE TABLE `ims_sudu8_page_cate` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=802 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
-- ----------------------------
-- Table structure for `ims_sudu8_page_formcon`
-- ----------------------------
...
-- ----------------------------
-- Records of ims_sudu8_page_formcon
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_sudu8_page_formlist`
-- ----------------------------
...
-- ----------------------------
-- Records of ims_sudu8_page_formlist
-- ----------------------------
...
-- ----------------------------
-- Table structure for `ims_sudu8_page_formt`
-- ----------------------------
...
-- ----------------------------
-- Records of ims_sudu8_page_formt
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_sudu8_page_money`
-- ----------------------------
...
-- ----------------------------
-- Records of ims_sudu8_page_money
-- ----------------------------
...
-- ----------------------------
-- Table structure for `ims_sudu8_page_navlist`
-- ----------------------------
...
-- ----------------------------
-- Records of ims_sudu8_page_navlist
-- ----------------------------
...
CREATE TABLE `ims_sudu8_page_products` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=1817 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
-- ----------------------------
-- Table structure for `ims_sudu8_page_recharge`
-- ----------------------------
...
-- ----------------------------
-- Records of ims_sudu8_page_recharge
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_sudu8_page_rechargeconf`
-- ----------------------------
...
-- ----------------------------
-- Records of ims_sudu8_page_rechargeconf
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_sudu8_page_score`
-- ----------------------------
...
-- ----------------------------
-- Records of ims_sudu8_page_score
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_sudu8_page_store`
-- ----------------------------
...
-- ----------------------------
-- Records of ims_sudu8_page_store
-- ----------------------------

-- ----------------------------
-- Table structure for `ims_sudu8_page_storeconf`
-- ----------------------------
...
-- ----------------------------
-- Records of ims_sudu8_page_storeconf
-- ----------------------------
...
CREATE TABLE `ims_sudu8_page_user` (
  ...
  `flag` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=14870 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
