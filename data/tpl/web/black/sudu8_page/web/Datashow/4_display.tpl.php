<?php defined('IN_IA') or exit('Access Denied');?><script src="/addons/sudu8_page/static/js/echarts.js" type="text/javascript" charset="utf-8"></script>
...
<link rel="stylesheet" type="text/css" href="/addons/sudu8_page/static/css/bootstrap.min.css" />
<link rel="stylesheet" type="text/css" href="/addons/sudu8_page/static/css/data_home.css?v180705v3" />
<script src="/addons/sudu8_page/static/js/jquery.js" type="text/javascript" charset="utf-8"></script>
<script src="/addons/sudu8_page/static/js/countUp.js" type="text/javascript" charset="utf-8"></script>
<div class="page">
	<div class="page_content" style="background-color: #F1F4F5;padding:0">
		<div class="row">
			<div class="w-20">
				<div class="card card-block data_card position-relative" style="border-top: 1px solid #6671E4;">
					...
					<div class="all_visit">
						<img src="/addons/sudu8_page/static/indexImg/visit.png" class="all_visit_img"/>
					</div>
				</div>
			</div>
			<div class="w-20">
				<div class="card card-block data_card position-relative" style="border-top: 1px solid #66E49E;">
					...
					<div class="all_customer">
						<img src="/addons/sudu8_page/static/indexImg/customer.png" class="all_visit_img"/>
					</div>
				</div>
			</div>
			<div class="w-20">
				<div class="card card-block data_card position-relative" style="border-top: 1px solid #ED8E20;">
					...
					<div class="all_member">
						<img src="/addons/sudu8_page/static/indexImg/member.png" class="all_visit_img"/>
					</div>
				</div>
			</div>
			<div class="w-20">
				<div class="card card-block data_card position-relative" style="border-top: 1px solid #E93C38;">
					...
					<div class="all_birthday">
						<img src="/addons/sudu8_page/static/indexImg/birthday.png" class="all_visit_img"/>
					</div>
				</div>
			</div>
			<div class="w-20">
				<div class="card card-block data_card" style="border-top: 1px solid #0079FE;">
					...
					<div class="all_recharge">
						<img src="/addons/sudu8_page/static/indexImg/recharge.png" class="all_visit_img"/>
					</div>
				</div>
			</div>
			</div>
					...
					<div class="order_des bg-fff mt-20 clearfix" id='today2'>
						<div class="col-sm-4">
							<div class="bg-F9F9F9 order_card order_card1 text-center">
								<div class="clearfix inline-block">
									<img class="fl block mt-10" src="/addons/sudu8_page/static/indexImg/order.png" />
									<div class="fl ml-10">
						...
						<div class="col-sm-4">
							<div class="bg-F9F9F9 order_card order_card2 text-center">
								<div class="clearfix inline-block">
									<img class="fl block mt-10" src="/addons/sudu8_page/static/indexImg/order2.png" />
									<div class="fl ml-10">
						...
						<div class="col-sm-4">
							<div class="bg-F9F9F9 order_card order_card3 text-center">
								<div class="clearfix inline-block">
									<img class="fl block mt-10" src="/addons/sudu8_page/static/indexImg/order3.png" />
									<div class="fl ml-10">
...
<div class="row">
			<div class="col-xl-6 mt-20">
				<div class="order_des bg-fff">
					<div class="order2_navbar clearfix">
						...
						<a href="index.php?c=site&a=entry&op=display&cateid=29&do=Orderset&m=sudu8_page" class="fr font-size-12 block  color-6671E4" style="line-height: 20px;">更多<span class="font-size-20 ml-10" style="vertical-align: -2px;">+</span></a>
					</div>
					<div class="order-table order-table1 mt-15" id='duo_platform_order'>
						<table>
							...
							<tbody>
								<?php  if(is_array($duo_platform_orders)) { foreach($duo_platform_orders as $item) { ?>
								...
								<tr>
						            ...
						            <?php  } ?>
						            <?php  if($item['flag'] =='2' && $item['nav'] == '2') { ?> <span class="btn btn-success btn-sm">已核销</span><?php  } ?>
						            <?php  if($item['flag'] =='3') { ?> <span class="btn btn-default btn-sm">已过期</span><?php  } ?>
						            <?php  if($item['flag'] =='4') { ?> <span class="btn btn-success btn-sm">已发货</span><?php  } ?>
						            <?php  if($item['flag'] =='5') { ?> <span class="btn btn-danger btn-sm">退换货</span><?php  } ?>
						            </td>
								</tr>
								<?php  } } ?>
							</tbody>
					...
					<div class="order-table order-table1 mt-15" style="display: none" id='duo_shop_order'>
						<table>
							...
							<tbody>
								<?php  if(is_array($duo_shop_orders)) { foreach($duo_shop_orders as $item) { ?>
								<tr>
									<td><?php  echo $item['order_id'];?></td>
									<td><?php  echo $item['pname'];?></td>
									<td>
					...
					<div class="order-table order-table1 mt-15" style="display: none" id='yuyue_orders'>
						<table>
							...
							<tbody>
								<?php  if(is_array($yuyue_orders)) { foreach($yuyue_orders as $item) { ?>
								<tr>
									<td><?php  echo $item['order_id'];?></td>
									<td><?php  echo $item['pname'];?></td>
									<?php  if($item['flag']=='0') { ?><td><span class="btn btn-default btn-sm">未付款</span></td><?php  } ?>
									<?php  if($item['flag']=='1') { ?><td><span class="btn btn-warning btn-sm">已支付</span></td><?php  } ?>
									<?php  if($item['flag']=='2') { ?><td><span class="btn btn-success btn-sm">已核销</span></td><?php  } ?>
									<?php  if($item['flag']=='3') { ?><td><span class="btn btn-default btn-sm">已过期</span></td><?php  } ?>
									<?php  if($item['flag']=='4') { ?><td><span class="btn btn-danger btn-sm">退换货</span></td><?php  } ?>
								</tr>
								<?php  } } ?>
							</tbody>
						</table>
					...
					<div class="order-table order-table1 mt-15" style="display: none" id='miaosha_orders'>
						<table>
							...
							<tbody>
								<?php  if(is_array($miaosha_orders)) { foreach($miaosha_orders as $item) { ?>
								<tr>
									<td><?php  echo $item['order_id'];?></td>
									<td><?php  echo $item['pname'];?></td>
									<?php  if($item['flag']=='0') { ?><td><span class="btn btn-default btn-sm">未付款</span></td><?php  } ?>
					...
					<div class="order-table order-table1 mt-15" style="display: none" id='pintuan_orders'>
						<table>
							...
							<tbody>
								<?php  if(is_array($pintuan_orders)) { foreach($pintuan_orders as $item) { ?>
								<tr>
									<td><?php  echo $item['order_id'];?></td>
									<td><?php  echo $item['pname'];?></td>
									<?php  if($item['flag']=='0') { ?><td><span class="btn btn-default btn-sm">未付款</span></td><?php  } ?>
			...
			<div class="col-xl-6 mt-20">
				<div class="order_des bg-fff">
					<div class="order2_navbar clearfix">
						...
						<a href="index.php?c=site&a=entry&op=pinglun&cateid=18&chid=26&do=commentset&m=sudu8_page" class="fr font-size-12 block  color-6671E4 " style="line-height: 20px;">更多<span class="font-size-20 ml-10" style="vertical-align: -2px;">+</span></a>
					</div>
					<div class="order-table order-table2 mt-15" id='articlec1'>
						<table>
							...
							<tbody>
								<?php  if(is_array($acticle_comments)) { foreach($acticle_comments as $item) { ?>
								<tr>
					...
					<div class="order-table order-table2 mt-15" style="display: none" id='articlec2'>
						<table>
							...
							<tbody>
								<?php  if(is_array($video_orders)) { foreach($video_orders as $item) { ?>
								<tr>
				...
				<div class="order_des bg-fff bottom3">
					...
					<div class="order-table collect_table mt-40">
						<table>
							...
							<tbody>
								<?php  if(is_array($collects)) { foreach($collects as $index => $item) { ?>
								<tr>
				...
				<div class="order_des bg-fff bottom3">
					...
					<div class="order-table collect_table mt-40">
						<table>
							...
							<tbody>
								<?php  if(is_array($sales)) { foreach($sales as $index => $item) { ?>
								<tr>
									<td><?php  echo $index+1?></td>
									<td><?php  echo $item['title'];?></td>
			...
			<div class="col-xl-4 mt-80">
				...
				<div class="order_des bg-fff bottom3">
					<a href="index.php?c=site&a=entry&op=display&cateid=37&do=Userset&m=sudu8_page" class="block text-right color-6671E4">更多<span class="font-size-20 ml-10" style="vertical-align: -2px;">+</span></a>
					<div class="order-table collect_table mt-40">
						<table>
							<thead>
								<tr>
							...
							<tbody>
								<?php  if(is_array($credits)) { foreach($credits as $index => $item) { ?>
								<tr>
									<td><?php  echo $index+1 ?></td>
...
<script type="text/javascript">
	...
	// $('#appoint6').click(function(){
	// 	$('#appoint6').addClass('on');
	// 	$('#appoint1').removeClass('on');
	// 	$('#appoint2').removeClass('on');
	// 	$('#appoint3').removeClass('on');
	// 	$('#appoint4').removeClass('on');
